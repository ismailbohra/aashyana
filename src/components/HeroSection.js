  ...
  return (
    ...
    >
      <div className="md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto">
        <h1 className="capitalize flex flex-col gap-2 md:gap-5 text-3xl sm:text-4xl md:text-[3.2rem] 2xl:text-3xl font-bold">
          <p>Innovate, Design, Develop</p>
          <p>Building the Future of the Web and Apps.</p>
        </h1>
        <p className="text-lg leading-normal sm:leading-loose my-4 md:my-6">
        Transforming concepts into digital brilliance, We specializes in web and app development. With MERN stack expertise and AI insights, we craft exceptional online solutions for your success.
        </p>
        <button className="md:text-base text-sm hover:border-2 border-2 border-transparent font-semibold py-3 px-8 md:px-10 text-white bg-rose-600 hover:border-rose-600 hover:bg-transparent hover:text-rose-600 rounded-full">
          <Link href="https://github.com/ismailbohra" target="_blank">
            Explore
          </Link>
        </button>
      </div>
